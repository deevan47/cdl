...
__decorate([
    (0, typeorm_1.OneToMany)(() => project_stage_entity_1.ProjectStage, (stage) => stage.project, { cascade: true }),
    __metadata("design:type", Array)
], Project.prototype, "stages", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => comment_entity_1.Comment, (comment) => comment.project, { cascade: true }),
    __metadata("design:type", Array)
...
__decorate([
    (0, typeorm_1.Column)({ name: 'archived', type: 'boolean', default: false }),
