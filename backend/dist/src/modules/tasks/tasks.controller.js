...
let TasksController = class TasksController {
    ...
    updateStatus(id, body) {
        return this.tasksService.update(id, { status: body.status, isCompleted: body.isCompleted });
    }
};
...
], TasksController.prototype, "findTasksByUserId", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    (0, common_1.Put)(':id/assign-user/:userId'),
    __param(0, (0, common_1.Param)('id')),
