...
let UsersController = class UsersController {
    ...
    getProjectManagers() {
        return this.usersService.findByRole(user_entity_1.UserRole.PROJECT_MANAGER);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getProjectManagers", null);
__decorate([
    (0, common_1.Get)(':id/assigned-projects'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getAssignedProjects", null);
